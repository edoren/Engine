...
elseif(APPLE AND IOS AND DEFINED ENV{MOLTENVK_SDK})
    ...
    set(VULKAN_REQUIRED_FRAMEWORKS "-framework Metal" "-framework IOSurface" "-framework QuartzCore")
...
if(VULKAN_REQUIRED_FRAMEWORKS)
    list(APPEND VULKAN_LIBRARIES ${VULKAN_REQUIRED_FRAMEWORKS})
endif()
